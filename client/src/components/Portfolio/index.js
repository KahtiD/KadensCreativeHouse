    ...
    <div className="sizing">
      ...
      <div className="gallery">
          ...
          <div id="one" className="one">
            <LazyLoad height={"100%"}>
              <img style={{objectFit: "cover"}} width="100%" height="100%" alt="" data-src={thumbnail} onClick={this.click.bind(this)} />
            </LazyLoad>
          </div>

          <div id="two" className="two">
            <LazyLoad height={"100%"}>
              <img style={{objectFit: "cover"}} width="100%" height="100%" alt="" data-src={thumbnail2} onClick={this.click2.bind(this)} />
            </LazyLoad>
          </div>

          <div id="three" className="three">
            <LazyLoad height={"100%"}>
              <img style={{objectFit: "cover"}} width="100%" height="100%" alt="" data-src={thumbnail3} onClick={this.click3.bind(this)} />
            </LazyLoad>
          </div>

          <div id="four" className="four">
            <LazyLoad height={"100%"}>
              <img style={{objectFit: "cover"}} width="100%" height="100%" alt="" data-src={thumbnail4} onClick={this.click4.bind(this)} />
            </LazyLoad>
          </div>

          <div id="five" className="five">
            <LazyLoad height={"100%"}>
              <img style={{objectFit: "cover"}} width="100%" height="100%" alt="" data-src={thumbnail5} onClick={this.click5.bind(this)} />
            </LazyLoad>
          </div>

          <div  id="six" className="six">
            <LazyLoad height={"100%"}>
              <img style={{objectFit: "cover"}} width="100%" height="100%" alt="" data-src={thumbnail6} onClick={this.click6.bind(this)} />
            </LazyLoad>
          </div>
